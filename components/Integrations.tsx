...
export default function Integrations() {
  return (
    <section className="w-full bg-background/80 text-white py-16 px-4 md:px-6 lg:px-8 bg-[url(/images/integrations_background.svg)] bg-no-repeat bg-cover bg-top bg-origin-content">
